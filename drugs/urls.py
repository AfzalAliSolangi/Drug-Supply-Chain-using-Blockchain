...
urlpatterns = [
    ...
    path('distorderstatus', views.distorderstatus, name='distorderstatus'),
    ...
    path('manuupdatesla', views.manuupdatesla, name='manuupdatesla'),
    path('manu_sla_upload', views.manu_sla_upload, name='manu_sla_upload'),
    path('distupdatesla', views.distupdatesla, name='distupdatesla'),
    path('dist_sla_upload', views.dist_sla_upload, name='dist_sla_upload'),
    path('pharmupdatesla', views.pharmupdatesla, name='pharmupdatesla'),
    path('pharm_sla_upload', views.pharm_sla_upload, name='pharm_sla_upload'),
    ...
    path('otp_master', views.otp_master, name='otp_master'),
    ...
    path('sell_checkout', views.sell_checkout, name='sell_checkout'),
    path('pharm_updateItems', views.pharm_updateItems, name='pharm_updateItems'),
    path('view_solditem', views.view_solditem, name='view_solditem'),
]
